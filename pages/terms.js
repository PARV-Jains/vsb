...
const Terms = () => {
  ...
  <div className="text-black-600 mx-2 md:mx-10 my-2 py-24">
    ...
    <p className="px-10 py-2">
      ...
      of Vikas Sev Bhandar&apos;s Website, located at www.vsb.com. By accessing this
      website we assume you accept these terms and conditions. Do not continue
      to use vsb.com if you do not agree to take all of the terms and
    ...
    <p className="px-10 py-2">
      We employ the use of cookies. By accessing vsb.com, you agreed to
      use cookies in agreement with the Vikas Sev Bhandar&#39s Privacy Policy. Most
    ...
    <p className="px-10 py-2">
      Unless otherwise stated, Vikas Sev Bhandar and/or its licensors own the
      intellectual property rights for all material on vsb.com. All
      intellectual property rights are reserved. You may access this from
      vsb.com for your own personal use subjected to restrictions set in
      these terms and conditions.
    </p>
    <div>
      <p className="mb-4 mx-10 font-semibold">You must not:</p>
      <li className="ml-10">Republish material from vsb.com</li>
      <li className="ml-10">
        Sell, rent or sub-license material from vsb.com
      </li>
      <li className="ml-10">
        Reproduce, duplicate or copy material from vsb.com
      </li>
      <li className="ml-10">Redistribute content from vsb.com</li>
    </div>
    ...
    <p className="mx-10 my-2 ">
      ...
      opinions and information in certain areas of the website. Vikas Sev Bhandar does
      ...
      Vikas Sev Bhandar,its agents and/or affiliates. Comments reflect the views and
      opinions of the person who post their views and opinions. To the extent
      permitted by applicable laws, Vikas Sev Bhandar shall not be liable for the
      ...
      Comments on this website. Vikas Sev Bhandar reserves the right to monitor all
    ...
    <div>
      ...
      <p className="mx-10 my-2">
        {" "}
        You hereby grant Vikas Sev Bhandar a non-exclusive license to use, reproduce,
    ...
    <p className="px-10 py-2">
      ...
      hyperlink compensates the absence of Vikas Sev Bhandar; and (d) the link is in the
      ...
      inform us by sending an e-mail to Vikas Sev Bhandar. Please include your name,
    ...
    <div>
      ...
      <p className="ml-10 mt-4">
        No use of Vikas Sev Bhandar&#39s logo or other artwork will be allowed for linking
