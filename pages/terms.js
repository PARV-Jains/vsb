...
License
Unless otherwise stated, Codeswear and/or its licensors own the intellectual property rights for all material on codeswear.com. All intellectual property rights are reserved. You may access this from codeswear.com for your own personal use subjected to restrictions set in these terms and conditions.

You must not:

Republish material from codeswear.com
Sell, rent or sub-license material from codeswear.com
Reproduce, duplicate or copy material from codeswear.com
Redistribute content from codeswear.com
This Agreement shall begin on the date hereof.
Parts of this website offer an opportunity for users to post and exchange opinions and information in certain areas of the website. Codeswear does not filter, edit, publish or review Comments prior to their presence on the website. Comments do not reflect the views and opinions of Codeswear,its agents and/or affiliates. Comments reflect the views and opinions of the person who post their views and opinions. To the extent permitted by applicable laws, Codeswear shall not be liable for the Comments or for any liability, damages or expenses caused and/or suffered as a result of any use of and/or posting of and/or appearance of the Comments on this website. Codeswear reserves the right to monitor all Comments and to remove any Comments which can be considered inappropriate, offensive or causes breach of these Terms and Conditions.
...
No use of Codeswear&apos;s logo or other artwork will be allowed for linking absent a trademark license agreement.
...
exclude any of our or your liabilities that may not be excluded under applicable la
